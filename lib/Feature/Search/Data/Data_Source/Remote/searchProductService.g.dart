...
part of 'searchProductService.dart';
...
class _searchProductService implements searchProductService {
  _searchProductService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<HttpResponse<List<searchProductModel>>> getProductbyCategory(
    ...
    var value = _result.data!
        .map((dynamic i) =>
            searchProductModel.fromJson(i as Map<String, dynamic>))
        .toList();
