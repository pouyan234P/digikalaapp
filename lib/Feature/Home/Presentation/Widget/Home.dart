...
import '../../../Product/Presentation/Widget/Category.dart';
      ...
      appBar: AppBar(
        title: FractionallySizedBox(
          ...
          child: TextButton(
            style: ButtonStyle(
              backgroundColor:
                  MaterialStateProperty.all(const Color(0xFFF0F0F1)),
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {},
                  child: const Column(
                    children: [Icon(Icons.ac_unit_sharp), Text('data')],
                  ),
                ),
              ],
            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                                'گوشی موبایل جی پلاس مدل Q20 دو سیم کارت',
                                style: TextStyle(
                                    fontSize: 15, fontWeight: FontWeight.bold)),
                            const Text('ارسال امروز',
                                style: TextStyle(fontSize: 12.5)),
                            const Text(' ۳,۲۹۹,۰۰۰ تومان',
                                style: TextStyle(fontSize: 12.15))
                          ],
                        ),
                      ),
                    ),
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/mobilecategory.png',
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/kalacategor.png',
                          width: MediaQuery.of(context).size.width * .25),
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/kitchencategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/modelandclothscatagory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/supermarketcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                      const Text('کالاهای '
                          'سوپرمارکتی'),
                    ],
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/bookscategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/toyscategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/beautycategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                      const Text('زیبایی و '
                          'سلامت'),
                    ],
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/sportandtravelcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/abzaryandtajehjatcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/carandmotorcekletcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                      const Text('خودرو و\n '
                          'موتورسیکلت'),
                    ],
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/bomiproductcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
                ...
                TextButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/images/giftcardcategory.png',
                          width: MediaQuery.of(context).size.width * .25),
